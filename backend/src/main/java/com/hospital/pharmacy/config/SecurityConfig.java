...
import com.hospital.pharmacy.security.TokenAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/integration/his/v1/**").permitAll()
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/pharmacy/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/pharmacy/**").hasAnyRole("ADMIN", "PHARMACIST")
                        .requestMatchers("/api/his/**").hasAnyRole("ADMIN", "PHARMACIST")
                        ...
                        .requestMatchers(HttpMethod.POST, "/dispense", "/return").hasAnyRole("ADMIN", "PHARMACIST")
